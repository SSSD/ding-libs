...
m4_define([VERSION_NUMBER], [0.1.3])
...
m4_define([COLLECTION_VERSION_NUMBER], [0.6.1])
m4_define([REF_ARRAY_VERSION_NUMBER], [0.1.2])
m4_define([BASICOBJECTS_VERSION_NUMBER], [0.1.0])
m4_define([INI_CONFIG_VERSION_NUMBER], [0.6.2])
